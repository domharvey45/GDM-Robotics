...
**Note:** C99 standard documentation for the C language may be found [here](https://devdocs.io/c/).
...
In order to simplify parameter processing, a serialised file format such as JSON or YAML should be used. **YAML is preferred for human legibility**.
